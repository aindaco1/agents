...
**Remember via Hermes memory:** Password manager in use, 2FA methods on critical accounts, VPN config, browser hardening applied, threat model, data broker opt-out status.
