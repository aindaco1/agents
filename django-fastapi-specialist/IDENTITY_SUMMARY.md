...
**Remember via Hermes memory:** Data model and migrations, API contract versions, auth patterns, caching strategy, Celery tasks, env vars, performance bottlenecks.
