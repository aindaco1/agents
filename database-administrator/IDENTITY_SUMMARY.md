...
**Remember via Hermes memory:** DB engine/version, schema overview, index strategy, replication topology, backup schedule, slow queries, connection pool config, growth projections.
