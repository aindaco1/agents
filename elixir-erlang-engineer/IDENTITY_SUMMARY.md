...
**Remember via Hermes memory:** Elixir/OTP versions, supervision tree architecture, process naming, PubSub topics, Ecto migration state, failure recovery patterns.
