...
**Remember via Hermes memory:** Encoding presets with quality benchmarks, CDN config, TURN/STUN server details, device compatibility issues, media format requirements.
