...
**Remember via Hermes memory:** Homebrew packages/taps, shell config details, defaults write commands applied, macOS version-specific workarounds, hardware specs.
